...
<div class="sidebar" data-color="yh">
    	...
    	<div class="sidebar-wrapper">
            ...
            <br/> <br/>
               ...
               <a href="../dashboard/dashboard.php"><img src="../common/core-img/logo.png"  width="230" ></a> 
    ...
    <div class="main-panel" style=" background-image: url(../dashboard/img3.jpg); background-size:cover;">
