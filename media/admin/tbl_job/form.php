...
elseif($name=="sports_type")
  {
	  ...
	  $result22 = mysqli_query($con,"select * from sports_details");
...
echo "<option value='$row22[id]'>$row22[sports_name]</option>";
...
else
{
  ...
  if($type_only=="varchar" || $type_only=="int" || $type_only=="int" || $type_only=="tinyint" )
  {
	  ...
	  ".str_replace('_', ' ', $name)."</label><input required type='text' name='$name'class='form-control' > </div>
                                        </div>";
   ...
   if($type_only=="date" )
  {
	  ...
	  <input type='date' required name='$name'  class='form-control' value='$date'></div></div>";
...
function showDate(date) {
  ...
  if($type_only=="tinytext" )
  {
	  ...
	  <input type='file' name='$name' required class='form-control'></div></div>";
  }
  if($type_only=="text" )
  {
	  echo "<div class='col-md-6'>
											...
											<textarea required name='$name'  class='form-control' rows='8'></textarea>
											</div>
											</div>";
  }
